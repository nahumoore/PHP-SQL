...
<?php require('./components/Nav/nav.php')?>
      <div style="margin: 85px 40px 40px">
        <?php require('./components/Table/add.php')?>
        <?php require('./components/Table/search.php')?>
        <?php require('./components/Table/table.php') ?>
      </div>
      <footer class="bg-light text-center text-lg-start" style="margin-top: 335px;">
      ...
      <?php require('./components/Table/edit.php')?>
