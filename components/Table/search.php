<div style="margin-bottom: 10px">
    <form action='' method='post'>
        <input type='text' name='input' placeholder='Buscar encomienda...' class='form-control' style='width: 240px; display:inline;'/>
        <button type='submit' class='btn btn-info'><i class="fa fa-search" aria-hidden="true" style='display:inline;'></i></button>
    </form>
</div>

<!-- Si este codigo comentado se borra, deja de funcionar la tabla no se porque. -->
